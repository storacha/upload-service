 ...
 * persisted to the store. In the browser an unextractable Ed25519 key will be
 * generated by default. In other environments an extractable Ed25519 key is
 * generated so it can be persisted in the node conf store.
 *
...
export async function create(options = {}) {
  ...
  const principal = options.principal ?? (await generate({ extractable: true }))
