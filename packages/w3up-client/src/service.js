...
export const accessServicePrincipal = DID.parse('did:web:upload.storacha.network')
...
export const uploadServicePrincipal = DID.parse('did:web:upload.storacha.network')
...
export const filecoinServicePrincipal = DID.parse('did:web:upload.storacha.network')
