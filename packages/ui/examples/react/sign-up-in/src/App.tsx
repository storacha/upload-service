import { Provider, useW3, StorachaAuth, useStorachaAuthEnhanced } from '@storacha/ui-react'
      ...
      <div className="max-w-2xl w-full">
        <div className="bg-white rounded-2xl shadow-md p-8 border border-[var(--hot-red)]">
          <div className="flex items-center gap-4 mb-6">
            <img src="/storacha-logo.svg" alt="Storacha" width={48} height={48} />
            <h1 className="text-2xl font-epilogue text-[var(--hot-red)]">Welcome to Storacha!</h1>
          </div>
          
          <div className="space-y-4">
            <div className="p-4 bg-[var(--hot-red-light)] rounded-xl">
              <p className="text-sm font-semibold text-[var(--hot-red)] mb-2">Authentication Status</p>
              <p className="text-gray-700">
                You&apos;re signed in as <b className="text-[var(--hot-red)]">{accounts[0]?.toEmail()}</b>
              </p>
            </div>
