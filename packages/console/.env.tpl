...
NEXT_PUBLIC_NOTICE_TEXT="EARN RACHA POINTS AND STORAGE CREDITS BY REFERRING FRIENDS" 
NEXT_PUBLIC_NOTICE_HREF="https://storacha.network/referrals" 
NEXT_PUBLIC_NOTICE_DISPLAY_UNTIL="2025-08-21"
NEXT_PUBLIC_NOTICE_DISMISSIBLE="true"
NEXT_PUBLIC_NOTICE_ENABLED="false"