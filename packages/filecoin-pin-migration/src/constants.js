...
export const DEFAULT_PULL_RETRIES = 2
...
export const DEFAULT_RETRY_MIN_TIMEOUT = 250
...
export const DEFAULT_PULL_CONCURRENCY = 32
export const DEFAULT_COMMIT_CONCURRENCY = 16
