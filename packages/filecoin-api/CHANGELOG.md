...
* upgrade data segment v4 ([#996](https://github.com/storacha/upload-service/issues/996))
...
* aggregate accept must query with aggregate only ([#1024](https://github.com/storacha/upload-service/issues/1024)) ([6fd909c](https://github.com/storacha/upload-service/commit/6fd909ccdc108a83b3ea122e2d66b0663c6f3484))
...
* aggregator service types have unused types ([#1039](https://github.com/storacha/upload-service/issues/1039)) ([eba8e51](https://github.com/storacha/upload-service/commit/eba8e514e90d266408b1271f438a339359206b1f))
...
* export tests in lib for events ([#1001](https://github.com/storacha/upload-service/issues/1001)) ([e442f32](https://github.com/storacha/upload-service/commit/e442f32ce09d1457bc1df6c96ad006ec082d428d))
* filecoin api store has returns false ([#1022](https://github.com/storacha/upload-service/issues/1022)) ([1960130](https://github.com/storacha/upload-service/commit/1960130d2e39135b6b2327c08a9dae3cce59b2c3))
* filecoin api test service context explicit exported ([#1034](https://github.com/storacha/upload-service/issues/1034)) ([aeceec8](https://github.com/storacha/upload-service/commit/aeceec8007426db9104b67fd68b2eace23bde0c5))
...
* import exports and types ([#998](https://github.com/storacha/upload-service/issues/998)) ([844d938](https://github.com/storacha/upload-service/commit/844d93837f0ac503f93533899f22984a7b293cd2))
...
* trigger release filecoin api ([#1032](https://github.com/storacha/upload-service/issues/1032)) ([7289a6b](https://github.com/storacha/upload-service/commit/7289a6b2d735db76cd0159c5b7d9fc881ff0c903))
* typo dealer event function name ([#1040](https://github.com/storacha/upload-service/issues/1040)) ([7900624](https://github.com/storacha/upload-service/commit/7900624469e3ec79f83adccd591e1c47a7034724))
* upgrade data segment v4 ([#996](https://github.com/storacha/upload-service/issues/996)) ([348e4b0](https://github.com/storacha/upload-service/commit/348e4b065909e48ab1e97c0eaee9fa0b5ad2e223))
...
* export context utils from filecoin api ([#1031](https://github.com/storacha/upload-service/issues/1031)) ([f3d2043](https://github.com/storacha/upload-service/commit/f3d2043f74232094e623c3bc44299dc7f6bb7851))
* export more types to filecoin api ([#1000](https://github.com/storacha/upload-service/issues/1000)) ([412792c](https://github.com/storacha/upload-service/commit/412792c8469f92e4cfe16587f0f3212ab4c7140f))
* **main:** release filecoin-api 2.0.0 ([#954](https://github.com/storacha/upload-service/issues/954)) ([f7ee580](https://github.com/storacha/upload-service/commit/f7ee580a23d110febbb3933acbf8cfa91b1184ce))
* **main:** release filecoin-api 2.0.1 ([#999](https://github.com/storacha/upload-service/issues/999)) ([311282b](https://github.com/storacha/upload-service/commit/311282b152bb01c0a297013c12497c5d3adb7634))
* **main:** release filecoin-api 2.0.2 ([#1002](https://github.com/storacha/upload-service/issues/1002)) ([7fab3e5](https://github.com/storacha/upload-service/commit/7fab3e502e354d48b428ebf32c1e11232140eebf))
* **main:** release filecoin-api 2.0.3 ([#1009](https://github.com/storacha/upload-service/issues/1009)) ([e440978](https://github.com/storacha/upload-service/commit/e440978a49a7eaabd6762e2d1e1aa5b5f8cb335b))
* **main:** release filecoin-api 3.0.0 ([#1020](https://github.com/storacha/upload-service/issues/1020)) ([0d344fa](https://github.com/storacha/upload-service/commit/0d344fadc7b53f50fb7c3221481516d17b32c8d7))
* **main:** release filecoin-api 3.0.1 ([#1023](https://github.com/storacha/upload-service/issues/1023)) ([ca93be4](https://github.com/storacha/upload-service/commit/ca93be4ada3c4e61e6481f44aebc5cfd03959b59))
* **main:** release filecoin-api 3.0.2 ([#1025](https://github.com/storacha/upload-service/issues/1025)) ([64b6b0f](https://github.com/storacha/upload-service/commit/64b6b0fdbb4ca7f7690bf1ab89c0eff0909259bb))
* **main:** release filecoin-api 3.0.3 ([#1033](https://github.com/storacha/upload-service/issues/1033)) ([6779741](https://github.com/storacha/upload-service/commit/67797417be7c42d95fa63855fbc4d5e98b48a806))
* **main:** release filecoin-api 3.0.4 ([#1035](https://github.com/storacha/upload-service/issues/1035)) ([54cba60](https://github.com/storacha/upload-service/commit/54cba6007560b6e7b28d83fd54941174d882872b))
