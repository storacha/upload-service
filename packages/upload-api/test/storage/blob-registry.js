import { BlobAPI as API } from '../../src/types.js'
import { ok, error, Failure } from '@ucanto/core'
import { equals } from 'multiformats/bytes'

/** @implements {API.Registry} */
export class Registry {
  constructor() {
    /** @type {Map<import('@storacha/access').SpaceDID, API.Entry[]>} */
    this.data = new Map()
  }

  /** @type {API.Registry['register']} */
